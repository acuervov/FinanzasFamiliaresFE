...
function NotFound() {
    return (
        <>
            <svg width="54px" height="54px" viewBox="0 0 74 64" xmlns="http://www.w3.org/2000/svg" className="flex absolute z-1 mx-6 my-6">
                <title>Shape</title>
            ...
            <div className="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center" style={{ backgroundImage: 'url(/demo/images/notfound/bg-404.jpg)' }}>
                <div className="z-1 text-center">
                    ...
                    <Link href="/">
                        <Button raised className="font-medium" label="Go to Dashboard" />
                    </Link>
                </div>
            </div>
        </>
