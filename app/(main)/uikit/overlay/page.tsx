...
const OverlayDemo = () => {
    ...
    const basicDialogFooter = <Button type="button" label="OK" onClick={() => setDisplayBasic(false)} icon="pi pi-check" className="p-button-outlined" />;
                    ...
                    <div className="card">
                        ...
                        <div className="grid">
                            <div className="col-12">
                                <Button className="p-button-outlined" type="button" label="Show" icon="pi pi-external-link" onClick={() => setDisplayBasic(true)} />
                            </div>
                        </div>
                    </div>
                    <div className="card">
