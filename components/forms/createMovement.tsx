...
const initialMovement = { description: '', amount: null, date: '', type: '', categoryId: '', subCategory: '', sourceId: '', bill: '', note: '' };
const initialErrors = { description: '', amount: '', date: '', type: '', categoryId: '', subCategory: '', sourceId: '', bill: '', note: '' };
