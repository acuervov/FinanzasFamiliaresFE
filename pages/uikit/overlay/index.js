...
const OverlayDemo = () => {
    ...
    const basicDialogFooter = <Button severity="secondary" label="OK" onClick={() => setDisplayBasic(false)} icon="pi pi-check" />;
    ...
    const confirmationDialogFooter = (
        <>
            <Button severity="secondary" label="No" icon="pi pi-times" onClick={() => setDisplayConfirmation(false)} text />
            <Button severity="secondary" label="Yes" icon="pi pi-check" onClick={() => setDisplayConfirmation(false)} text autoFocus />
        </>
    );
        ...
        <>
            ...
            <div className="grid">
                    ...
                    <div className="card">
                        ...
                        <div className="grid">
                            <div className="col-12">
                                <Button severity="secondary" label="Show" icon="pi pi-external-link" onClick={() => setDisplayBasic(true)} />
                            </div>
                        </div>
                    </div>
                    <div className="card">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <div>
                                <Button severity="success" label="Image" onClick={toggle} />
                            ...
                            <div>
                                <Button severity="success" label="DataTable" onClick={toggleDataTable} />
                ...
                <div className="col-12 lg:col-6">
                    <div className="card">
                        <h5>Confirmation</h5>
                        <Button label="Delete" severity="danger" icon="pi pi-trash" onClick={() => setDisplayConfirmation(true)} />
                    ...
                    <div className="card">
                        ...
                        <Button severity="warning" icon="pi pi-arrow-right" onClick={() => setVisibleLeft(true)} style={{ marginRight: '.25em' }} />
                        <Button severity="warning" icon="pi pi-arrow-left" onClick={() => setVisibleRight(true)} style={{ marginRight: '.25em' }} />
                        <Button severity="warning" icon="pi pi-arrow-down" onClick={() => setVisibleTop(true)} style={{ marginRight: '.25em' }} />
                        <Button severity="warning" icon="pi pi-arrow-up" onClick={() => setVisibleBottom(true)} style={{ marginRight: '.25em' }} />
                        <Button severity="warning" icon="pi pi-external-link" onClick={() => setVisibleFullScreen(true)} />
                    </div>
                </div>
                ...
                <div className="col-12 lg:col-6">
                    <div className="card">
                        ...
                        <div className="flex align-items-center gap-2">
                            ...
                            <Button severity="secondary" label="Save" icon="pi pi-check" tooltip="Click to proceed" />
                        </div>
                    </div>
                </div>
                <div className="col-12 lg:col-6">
