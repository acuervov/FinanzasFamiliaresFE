        ...
        <div className="grid">
            <div className="col-12 lg:col-6">
                <div className="card">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Button severity="warning" onClick={showWarn} label="Warn" />
            ...
            <div className="col-12 lg:col-6">
                <div className="card">
                    <h5>Messages</h5>
                    <div className="flex flex-wrap gap-2">
                        <Button label="Success" severity="success" onClick={addSuccessMessage} />
                        <Button label="Info" severity="info" onClick={addInfoMessage} />
                        <Button label="Warning" severity="warning" onClick={addWarnMessage} />
