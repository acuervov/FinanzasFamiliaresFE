          ...
          <div className="card">
            ...
            <div className="grid mt-3">
              ...
              >
                ...
                <img
                  src={`/demo/images/dashboard/graph-new.svg`}
              ...
              >
                ...
                <img
                  src={`/demo/images/dashboard/graph-completed.svg`}
                  className="absolute w-11"
                  style={{ left: "5%", bottom: 0 }}
                />
              </div>
              ...
              >
                ...
                <img
                  src={`/demo/images/dashboard/graph-refunded.svg`}
                  className="absolute w-11"
                  style={{ left: "5%", bottom: 0 }}
                />
              </div>
              ...
              >
                ...
                <img
                  src={`/demo/images/dashboard/graph-cancelled.svg`}
                  className="absolute w-11"
                  style={{ left: "5%", bottom: 0 }}
                />
              </div>
          ...
          <div className="card">
            ...
            <div className="mt-4">
              ...
              <div
                ...
                style={{ height: "7px", backgroundColor: "var(--surface-d)" }}
              >
                <div
                  className="w-7 h-full border-round"
            ...
            <div className="mt-4">
              ...
              >
                <div
                  className="w-5 h-full border-round"
            ...
            <div className="mt-4">
              ...
              >
                <div
                  className="w-8 h-full border-round"
            ...
            <div className="mt-4">
              ...
              >
                <div
                  className="w-4 h-full border-round"
            ...
            <div className="mt-4">
              ...
              >
                <div
                  className="w-6 h-full border-round"
                    ...
                    <div className="flex justify-content-between align-items-center">
                      <div className="flex gap-3 align-items-center">
                        <img
                          ...
                          className="w-5rem h-3rem shadow-5"
                          alt={product.name}
                        />
                ...
                >
                  <div className="flex justify-content-between align-items-center">
                    <div className="flex gap-2 align-items-center">
                      <img
                        src={`/demo/images/avatar/${member.image}.png`}
