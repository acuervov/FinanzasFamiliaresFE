    ...
    const uploadBodyCenter = () => {
        return (
            <div className="text-center">
                <Button icon="pi pi-times" severity="danger" text rounded className="mr-2"></Button>
                ...
                <div className="flex flex-wrap gap-5">
                    ...
                    >
                        ...
                        <Button
                            ...
                            rounded
                            icon="pi pi-times"
                            className="hover:flextext-sm absolute justify-content-center align-items-center cursor-pointer"
                    ...
                    <div key={i} className="col-12 md:col-6 lg:col-3">
                        <div className="card h-full">
                            <div className="flex align-items-center justify-content-between mb-3">
                                ...
                                <div>
                                    <Button icon={metric.icon} text rounded className="p-button-sm" onClick={(event) => menu.current.toggle(event)}></Button>
