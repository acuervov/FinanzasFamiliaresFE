            ...
            <div className="grid">
                ...
                <div className="col-12 lg:col-4">
                    <div className="border-1 surface-border border-round mb-4">
                        ...
                        <div className="p-3">
                            <div className="surface-100 p-3 flex align-items-center border-round">
                                ...
                                <Button rounded text icon="pi pi-fw pi-pencil" className="ml-auto"></Button>
                            </div>
                        </div>
                        <div className="p-3">
                            <div className="surface-100 p-3 flex align-items-center border-round">
                    ...
                    <div className="flex justify-content-between gap-3">
                        <Button outlined severity="danger" className="flex-1" label="Discard" icon="pi pi-fw pi-trash"></Button>
