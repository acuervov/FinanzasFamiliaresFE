  ...
  return (
    <div className="relative overflow-hidden flex flex-column justify-content-center">
      ...
      <div id="home" className="pages-wrapper z-1">
        <div
          className="px-4 md:px-8 flex align-items-center justify-content-between relative lg:static"
        ...
        >
          ...
          >
            <a
              ref={menuRef}
              href="#home"
              className="cursor-pointer lg:hidden flex text-white"
            >
          ...
          <div
            ...
            className={classNames(
              "align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 top-100 z-1 shadow-2 lg:shadow-none md:bg-transparent",
              { hidden: isHidden }
            )}
          >
        ...
        <div className="px-4 md:px-8 z-2">
          <div className="grid justify-content-between mb-6 md:mb-8 mt-5">
            <div className="col-12 lg:col-6 text-center lg:text-left flex flex-column gap-3">
              <span className="font-bold text-4xl text-white text-center md:text-left w-full md:w-9">
                PrimeTek Proudly Presents Theme Diamond
              </span>
              <p className="w-full md:w-9 text-center md:text-left font-semibold text-white">
                Modern and elegant responsive application template with a
                premium look for PrimeReact components.
              </p>
              <a
                role="button"
            ...
            <div className="col-12 text-center md:text-right lg:col-6">
              <img
                src={`/layout/images/pages/landing/header-image.png`}
                className="w-full sm:w-auto animation-duration-200 fadeinright"
                alt="Diamond Dashboard"
              />
            </div>
          </div>
          ...
          <div id="features" className="my-6 md:my-8 py-4">
            <div className="w-full text-center">
              <span className="block font-bold text-5xl mb-2">
                Meet Diamond
              </span>
              <span className="block font-bold text-lg text-color-secondary">
            ...
            <div className="grid mt-8">
              <div className="col-12 md:col-6 lg:col-3 text-center px-5">
                <img
                  src={`/layout/images/pages/landing/icon-devices.svg`}
                  alt="Devices"
                  className="w-3rem h-3rem mb-4 animation-duration-200 fadeinleft"
                />
                <span className="text-2xl font-bold block">Responsive</span>
                <span className="font-bold block mt-3 text-color-secondary">
              ...
              <div className="col-12 md:col-6 lg:col-3 text-center px-5">
                <img
                  src={`/layout/images/pages/landing/icon-design.svg`}
                  alt="Devices"
                  className="w-3rem h-3rem mb-4 animation-duration-200 fadeindown"
                />
              ...
              <div className="col-12 md:col-6 lg:col-3 text-center px-5">
                <img
                  src={`/layout/images/pages/landing/icon-document.svg`}
                  alt="Devices"
                  className="w-3rem h-3rem mb-4 animation-duration-200 fadeindown"
                />
              ...
              <div className="col-12 md:col-6 lg:col-3 text-center px-5">
                <img
                  src={`/layout/images/pages/landing/icon-diamond.svg`}
                  alt="Devices"
                  className="w-3rem h-3rem mb-4 animation-duration-200 fadeinright"
                />
                <span className="text-2xl font-bold block">
                  Premium Support
                </span>
          ...
          <div
            id="theming"
            className="grid row-gap-8 my-6 md:my-8 py-4 justify-content-between align-items-center"
          >
            <div className="col-12 md:col-5 flex-order-0">
              <div
                className="w-5rem bg-primary mb-2 border-round"
                style={{ height: "4px" }}
              ></div>
              <span className="text-2xl font-bold block mb-4">
                Cras suscipit mauris nisl. Donec molestie maximus tellus
              </span>
              <span className="block font-semibold">
                Cras suscipit mauris nisl. Donec molestie maximus tellus, eu
                congue elit interdum vitae. Pellentesque habitant morbi
                tristique senectus et netus et malesuada fames ac turpis
                egestas. Aenean finibus laoreet lorem, non pretium elit. Nunc
                vel commodo velit, eu venenatis dolor.
              </span>
            </div>
            <div className="col-12 md:col-6 flex-order-1">
              <img
                src={`/layout/images/pages/landing/feature-image-1.png`}
                className="w-full animation-duration-200 fadeinright"
                alt="Theming"
              />
            </div>
            ...
            <div className="col-12 md:col-6 flex-order-3 md:flex-order-2">
              <img
                src={`/layout/images/pages/landing/feature-image-2.png`}
                className="w-full animation-duration-200 fadeinleft"
                alt="Theming"
              />
            </div>
            <div className="col-12 md:col-5 text-right h-full flex-order-2 md:flex-order-3">
              <div
                className="w-5rem bg-primary mb-2 border-round ml-auto"
                style={{ height: "4px" }}
              ></div>
              <span className="text-2xl font-bold block mb-4">
                Cras suscipit mauris nisl. Donec molestie maximus tellus
            ...
            <div className="col-12 md:col-6 flex-order-5">
              <img
                src={`/layout/images/pages/landing/feature-image-3.png`}
                className="w-full animation-duration-200 fadeinright"
                alt="Theming"
              />
            </div>
          ...
          <div id="pricing" className="my-6 md:my-8 py-4 text-center">
            ...
            <span className="block font-bold text-color-secondary text-xl">
            ...
            <div className="grid justify-content-center lg:justify-content-between xl:justify-content-center mt-7">
              ...
              <div className="col-12 md:col-6 lg:col-4 xl:col-3 lg:p-3 xl:p-5 flex-shrink-0">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(45deg, var(--blue-700) 0%, var(--blue-500) 100%)",
                  }}
                >
          ...
          <div
            id="contact"
            className="grid justify-content-center lg:justify-content-evenly mt-6 md:mt-8 pt-4"
          >
            <div className="col-12 text-center mb-5 text-white">
              <span className="block text-5xl font-bold mb-3">
