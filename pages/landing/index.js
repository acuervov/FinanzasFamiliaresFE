    ...
    <div className="relative overflow-hidden flex flex-column justify-content-center">
      ...
      <div id="home" className="pages-wrapper z-1">
        ...
        >
          ...
          <div
            id="menu"
            className="align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 top-100 z-1 shadow-2 lg:shadow-none md:bg-transparent"
          >
