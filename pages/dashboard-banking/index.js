      ...
      <div className="grid">
        <div className="col-12 flex align-items-center justify-content-between flex-wrap gap-5">
          <div className="mx-auto sm:mx-0">
            ...
            <div className="flex align-items-center">
              ...
              <span
                className="text-green-700 border-round font-semibold ml-4 p-2 white-space-nowrap"
        ...
        {metrics.map((metric, index) => (
          <div key={metric.title} className="col-12 md:col-4">
            <div
              className="card flex w-full relative h-14rem overflow-hidden"
              onMouseEnter={() => handleMouseEnter(index)}
              onMouseLeave={handleMouseLeave}
            >
              <div className="flex w-full justify-content-between p-1">
                <div>
                  <span className="block white-space-nowrap font-semibold">
                    {metric.title}
                  </span>
                ...
                <div className="text-right">
                  ...
                  <span className="block text-color-secondary mt-2 white-space-nowrap">
                    vs last week
                  </span>
                </div>
              </div>
              <img
                src={`/demo/images/dashboard/${metric.image}.svg`}
              ...
              {hoveredIndex === index && (
                <Button
                  ...
                  rounded
                  severity="secondary"
                  className="p-ripple font-semibold absolute"
                  style={{ borderRadius: "50px", left: "36%", bottom: "10%" }}
                />
              )}
            </div>
          </div>
          ...
          <div className="card">
            ...
            >
              <Column
                body={(transaction) => (
                  <span
                    className="white-space-nowrap flex w-3rem h-3rem align-items-center justify-content-center border-round-xl"
                    style={{ backgroundColor: "rgba(77, 182, 172, 0.1)" }}
                  >
                    <i
                      className={`text-2xl text-color ${transaction.icon}`}
                    ></i>
                  </span>
                )}
              />
              <Column
                body={(transaction) => (
                  <>
                    <span className="white-space-nowrap block font-semibold">
                      {transaction.title}
                    </span>
                    <span className="block text-color-secondary font-sm font-bold">
                      {transaction.date}
                    </span>
                  </>
                )}
              ...
              <Column
                body={(transaction) => (
                  <span className="white-space-nowrap p-2 surface-ground font-semibold">
                    {transaction.badge}
                  </span>
                )}
              />
              <Column
                body={(transaction) => (
                  <span
                    className={`white-space-nowrap block font-semibold text-lg text-right ${
                      transaction.received ? "text-green-700" : ""
                    }`}
                  >
                    {transaction.amount}
                  </span>
        ...
        <div className="h-full col-12 xl:col-4">
          <Card className="h-full">
            ...
            {expenses.map((expense) => (
              <div
                key={expense.title}
                className="flex gap-3 w-full mt-4 align-items-center"
              >
                <img
                  src={`/demo/images/dashboard/${expense.image}.svg`}
                  alt={expense.title}
                ...
                <div className="w-full">
                  <div className="flex flex-wrap w-full justify-content-between align-items-center">
                    ...
                    <div className="flex">
                      <span className="font-semibold text-color-secondary pr-2 border-right-2 surface-border text-sm">
                        {expense.value}%
                      </span>
        ...
        <div className="col-12 xl:col-6">
          <div className="card h-full">
            <div className="flex align-items-center">
              ...
              <span
                className="w-2rem h-2rem flex justify-content-center align-items-center border-circle text-green-700 font-semibold"
                style={{ backgroundColor: "rgba(77, 182, 172, 0.1)" }}
              >
                2
              </span>
            ...
            <div className="grid flex-column sm:flex-row grid-nogutter border-round-xl mt-4">
              <div
                className="col-12 sm:col-6 p-4 border-round-top-xl sm:border-noround-right sm:border-round-left-xl justify-content-between"
                style={{ backgroundColor: "rgba(77, 182, 172, 0.1)" }}
              >
                ...
                <span className="block text-3xl font-semibold mt-3">
                  ...
                  <span
                    ...
                    style={{ color: "rgba(77, 182, 172, 0.7)" }}
                  >
                    .67
                  </span>
                </span>
              ...
              <div
                className="col-12 sm:col-6 p-4 border-round-bottom-xl sm:border-noround-left sm:border-round-right-xl flex align-items-center justify-content-center sm:justify-content-end"
              ...
              >
                <Button
                  ...
                  severity="success"
                  text
                  className="p-ripple surface-section font-semibold"
                  style={{ color: "#4DB6AC" }}
                />
              </div>
            </div>
              ...
              <div className="col">
                ...
                >
                  <div className="flex w-full align-items-center">
                    <img
                      src={`/demo/images/dashboard/mastercard.svg`}
                      alt="mastercard"
                      className="w-4rem mr-2"
                    />
                    <span className="text-2xl font-semibold white-space-nowrap">
                      Personal Card
                    </span>
                    <img
                      src={`/demo/images/dashboard/chip.svg`}
                      alt="mastercard"
                  ...
                  <div className="flex justify-content-between align-items-center mb-6">
                    ...
                    <div>
                      <span
                        className="font-bold px-2 border-right-2"
                  ...
                  ></span>
                  <span
                    className="h-3rem w-4 absolute bottom-0 right-0"
                    style={{
