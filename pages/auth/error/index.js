...
<div className="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center" style={{backgroundImage: "url(/demo/images/auth/bg-error.jpg)"}}>
      <div className="z-1 text-center">
        <div className="text-900 font-bold text-white text-8xl mb-4">ERROR</div>
        <p className="line-height-3 text-white mt-0 mb-5 text-700 text-xl font-medium">Something went wrong.</p>
        <Button severity="danger" className="font-medium" >Go to Dashboard</Button>
      </div>
    </div>
    </>
  );
