...
<div className="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center" style={{backgroundImage: 'url(/demo/images/auth/bg-access.jpg)'}}>
    <div className="relative text-center">
      ...
      <Button severity="warning" className="font-medium" >Go to Dashboard</Button>
    </div>
  </div>
    </>
  );
