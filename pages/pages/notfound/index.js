  ...
  return (
    <>
      <svg
        ...
        className="flex absolute z-1 mx-6 my-6"
      >
        <title>Shape</title>
        <g
          id="Page-1"
      ...
      <div
        className="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center"
        style={{ backgroundImage: "url(/demo/images/notfound/bg-404.jpg)" }}
      >
        <div className="z-1 text-center">
          <div className="text-900 font-bold text-white text-8xl mb-4">
            NOT FOUND
          </div>
          <p className="line-height-3 text-white mt-0 mb-5 text-700 text-xl font-medium">
