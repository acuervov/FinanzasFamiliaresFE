                ...
                <div className="p-0 m-0">
                    <div className="surface-section grid grid-nogutter formgrid flex-column md:flex-row gap-6 p-5 border-round">
                        ...
                        <div className="col-12 field">
                            <Tooltip target=".toggle-content" content={displayMessage ? 'Hide Content' : 'Show Content'} />
                            <span className="toggle-content surface-ground cursor-pointer border-round px-2" onClick={toggleMessage}>
