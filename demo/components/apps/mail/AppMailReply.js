            ...
            {content ? (
                <div className="p-0 m-0">
                    <div className="surface-section grid grid-nogutter formgrid flex-column md:flex-row gap-6 p-5 border-round">
                        <div className="col">
                            <label htmlFor="to" className="block text-900 font-semibold mb-3">
                                To
                            </label>
                        ...
                        <div className="col">
                            <label htmlFor="Subject" className="block text-900 font-semibold mb-3">
                                Subject
                            </label>
                            <span className="p-input-icon-left w-full" style={{ height: '3.5rem' }}>
                        ...
                        {displayMessage ? <div className="border-1 surface-border border-round p-4">{content.message}</div> : null}
                        <div className="col-12 field">
                            <span className="surface-ground cursor-pointer border-round px-2" onClick={toggleMessage}>
                    ...
                    <div className="flex column-gap-3 justify-content-end p-5 border-top-1 surface-border">
                        ...
                        <Button className="h-3rem" icon="pi pi-send" label="Send" onClick={sendMail}></Button>
                    </div>
                </div>
            ) : null}
        </React.Fragment>
