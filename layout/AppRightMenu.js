...
const AppRightMenu = () => {
  const { layoutState, setLayoutState, onRightMenuClick } = useContext(LayoutContext);
  const amount = [
    {
      label: "*****24",
  ...
  return (
    <div className={sidebarClassName} onClick={onRightMenuClick}>
      <Sidebar
        ...
        onHide={() =>  setLayoutState((prevLayoutState) => ({
          ...prevLayoutState,
        ...
        <div className="p-2">
          ...
          <div className="timeline mb-5">
            <div className="pt-0 pr-3 pb-3 pl-3 border-left-1 surface-border relative ml-2">
              <span
                className="absolute left-0 top-0 bg-blue-500 text-white border-circle w-2rem h-2rem inline-flex align-items-center justify-content-center"
            ...
            <div className="pt-0 pr-3 pb-3 pl-3 border-left-1 surface-border relative ml-2">
              <span
                className="absolute left-0 top-0 bg-indigo-500 text-white border-circle w-2rem h-2rem inline-flex align-items-center justify-content-center"
                style={{ transform: "translateX(-50%)" }}
              >
                <i className="timeline-icon pi pi-download"></i>
              </span>
              <div className="font-semibold mb-2 ml-2">
            ...
            <div className="pt-0 pr-3 pb-3 pl-3 border-left-1 surface-border relative ml-2">
              <span
                className="absolute left-0 top-0 bg-purple-500 text-white border-circle w-2rem h-2rem inline-flex align-items-center justify-content-center"
                style={{ transform: "translateX(-50%)" }}
              >
            ...
            <div className="pt-0 pr-3 pb-3 pl-3 border-left-1 surface-border relative ml-2">
              <span
                className="absolute left-0 top-0 bg-green-500 text-white border-circle w-2rem h-2rem inline-flex align-items-center justify-content-center"
                style={{ transform: "translateX(-50%)" }}
              >
          ...
          <img
            className="logo-image w-full"
            src={`/demo/images/sidebar-right/staticmap.png`}
            alt="diamond-react"
          />
        </div>
      </Sidebar>
